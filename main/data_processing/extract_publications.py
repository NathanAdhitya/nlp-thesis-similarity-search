...
from main.data_processing.dewey_cleanup import standardize_name, extract_contributor_info, is_advisor_role
...
if __name__ == "__main__":
    ...
    # Extract thesis data
    extract_dewey_thesis_data("../data/dewey_thesis",
                              name_to_dewey_id, "../data/cleaned_dewey.csv")

    # Extract publication data
    extract_publication_data(
        "../data/publications", name_to_scholar_id, "../data/cleaned_publications.csv")
