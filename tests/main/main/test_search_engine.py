...
class TestSearchEngine(unittest.TestCase):
    ...
    @patch("main.main.search_engine.GoogleTranslator")
    @patch("main.main.search_engine.SentenceTransformer")
    @patch("main.main.search_engine.BGEM3FlagModel")
    ...
    @patch("main.main.search_engine.sqlite3.connect")
