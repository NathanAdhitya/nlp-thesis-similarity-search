...
from data_pipeline.processing.extract_publications import (
...
@patch("main.data_processing.dewey_cleanup.extract_contributor_info")
@patch("main.data_processing.dewey_cleanup.is_advisor_role", return_value=True)
