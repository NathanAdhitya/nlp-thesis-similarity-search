...
from data_pipeline.processing.scholar_cleanup import (
...
@patch("main.data_processing.dewey_cleanup.standardize_name", side_effect=lambda x: x.lower())
...
@patch("main.data_processing.dewey_cleanup.standardize_name", side_effect=lambda x: x.strip().lower())
@patch("main.data_processing.dewey_cleanup.cluster_names_by_similarity", return_value={"alice": ["alice", "alise"]})
...
@patch("main.data_processing.dewey_cleanup.standardize_name", return_value="")
