...
try:
    from data_pipeline.processing.path_utils import get_dewey_thesis_dir, get_canonical_dewey_file
except ImportError:
    from path_utils import get_dewey_thesis_dir, get_canonical_dewey_file
...
def analyze_thesis_advisors(data_dir: str, max_distance: float = 2.0, save_canonical: bool = True):
    ...
    if save_canonical:
        output_file = str(get_canonical_dewey_file())
...
if __name__ == "__main__":
    try:
        from data_pipeline.processing.path_utils import get_canonical_dewey_file
    except ImportError:
        from path_utils import get_canonical_dewey_file
    ...
    # Run main analysis
    data_directory = str(get_dewey_thesis_dir())
