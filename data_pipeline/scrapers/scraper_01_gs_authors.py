...
def scrape_authors():
    ...
    try:
        ...
        with open(output_file, "w", newline="", encoding="utf-8") as f:
            ...
            # python types are pain.
            search_query = typing.cast(
                dict, scholarly.search_author_by_organization(org_id)
            )

            count = 0
            for author in search_query:
                # Make sure email_domain is not @john.petra.ac.id
                if author.get("email_domain") == "@john.petra.ac.id":
                    continue
